...
public class GmailEmailService implements EmailService {
    ...
    public void sendVerificationEmail(User user, String token) {
        ...
        message.setText("Hej " + user.getUsername() + "!\n\nKlicka här för att verifiera ditt konto: /verify?token=" + token + "\n\nMvh,\nCTRLBUY Team");
    ...
    public void sendVerificationEmail(String email, String token, String firstName) {
        ...
        message.setTo(email);
        message.setSubject("🔐 Verifiera ditt CTRLBUY-konto");
        message.setText("Hej " + firstName + "!\n\nKlicka här för att verifiera: /verify?token=" + token + "\n\nMvh,\nCTRLBUY Team");
        mailSender.send(message);
    }
    ...
    public void sendPasswordResetEmail(User user, String resetToken) {
        ...
        message.setText("Hej " + user.getUsername() + "!\n\nKlicka här för att återställa ditt lösenord: /reset?token=" + resetToken + "\n\nMvh,\nCTRLBUY Team");
        mailSender.send(message);
    }
    ...
    public void sendPasswordResetEmail(String email, String resetToken, String firstName) {
        ...
        message.setTo(email);
        message.setSubject("🔑 Återställ lösenord - CTRLBUY");
        message.setText("Hej " + firstName + "!\n\nKlicka här för att återställa: /reset?token=" + resetToken + "\n\nMvh,\nCTRLBUY Team");
        mailSender.send(message);
    }
